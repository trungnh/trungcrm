                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group input-group">
                                ...
                                <span class="form-control font-weight-bold text-red">{{formatNumber(totalUnitPrice)}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-group input-group">
                                ...
                                <span class="form-control font-weight-bold text-red">{{formatNumber(totalAds)}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-group input-group">
                                ...
                                <span class="form-control font-weight-bold text-red">{{formatNumber(totalRevenue)}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-group input-group">
                                ...
                                <span class="form-control font-weight-bold text-red bg-yellow">{{formatNumber(totalProfit)}} ({{formatNumber(totalProfitRate)}}%)</span>
                            </div>
                        </div>
                    </div>
                </div>
